...
const InterviewExperiences = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-gray-950 transition-colors">
      <main className="max-w-4xl mx-auto px-4 pb-10 pt-28 sm:pt-32">
        <div className="flex items-center justify-between mb-8 gap-3">
          <h1 className="text-3xl font-bold text-gray-800 dark:text-white">Interview Experiences</h1>
          <button
            onClick={handleShareExperience}
            className="bg-indigo-600 text-white px-5 py-2 rounded-lg font-medium hover:bg-indigo-700 transition whitespace-nowrap"
          >
            + Share Experience
          </button>
        </div>
